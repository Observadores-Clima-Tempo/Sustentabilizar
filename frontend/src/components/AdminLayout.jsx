...
const NAV_ITEMS = [
  { to: '/admin/checklist',    label: 'Diagnóstico',  icon: '📋' },
  { to: '/admin/pontuacao',    label: 'Pontuação',    icon: '⭐' },
  { to: '/admin/certificacao', label: 'Certificação', icon: '🏆' },
  { to: '/admin/residuos',     label: 'Resíduos',     icon: '♻️' },
]
    ...
    <div className="min-h-screen bg-gray-100 flex">
      ...
      >
        ...
        <div className="px-6 py-5 border-b border-gray-200">
          ...
          <p className="text-xs text-green-700 font-medium mt-1 pl-7">Painel Admin</p>
        </div>
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <header className="lg:hidden bg-white border-b border-gray-200 px-4 py-3 flex items-center gap-3">
          ...
          <span className="text-sm font-semibold text-gray-900">Admin · Sustentabilizar</span>
        </header>
