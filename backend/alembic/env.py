...
# Adiciona o diretório backend ao path para que os módulos app/ sejam encontrados
...
from app.models import admin_config, checklist_response, certification  # noqa: F401
